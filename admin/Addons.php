                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h1 class="card-title">Addons</h1>

                            <a href="create_addon.php" style="margin-bottom:12px !important;"
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                <tbody>
                                    ...
                                    $fetch_addon = mysqli_query($con, "SELECT * FROM `addon`  WHERE is_deleted = 0 AND `organizer_id` = $id ;");

                                    foreach ($fetch_addon as $addon) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger"
                                                    onclick="openDeleteModal('<?php echo $addon['Addon_id']; ?>');">Delete</button>
