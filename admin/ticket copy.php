...
JOIN 
    ticket_type tt ON t.ticket_type_id = tt.ticket_type_id AND `organizer_id` = " . $_SESSION['Organizer']['id'] . ";");
    ...
    '<?php echo $ticket['discount']; ?>');">Edit</button>
                                            ...
                                            <button class="btn btn-danger"
                                                onclick="openDeleteModal('<?php echo $ticket['ticket_id']; ?>');">Delete</button>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
