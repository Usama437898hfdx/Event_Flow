                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <?php $totalAttendee = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(role) as total_attendee FROM users WHERE role='Attendee'"))['total_attendee'] ?? 0;?>
                                    <h2 class="text-white"><?php echo $totalAttendee?></h2>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white">Total Organizer</h3>
                                <div class="d-inline-block">
                                <?php $totalOrganizer = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(role) as total_organizers FROM users WHERE role='Organizer'"))['total_organizers'] ?? 0;
                                     ?>
                                    <h2 class="text-white"><?php echo $totalOrganizer?></h2>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                <?php $totalEvents = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(event_id) as total_events FROM events"))['total_events'] ?? 0;
                                     ?>
                                    <h2 class="text-white"><?php echo $totalEvents ?></h2>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">Live Events</h3>
                                <div class="d-inline-block">
                                <?php $total_liveEvents = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(event_id) as total_liveevents FROM events WHERE is_deleted = 0 AND is_active = 1"))['total_liveevents'] ?? 0;
                                     ?>
                                    <h2 class="text-white"><?php echo $total_liveEvents ?></h2>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card card-widget">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <h4>20</h4>
                                        <h6 class="m-t-10 text-muted">Cash On Delivery <span class="pull-right">20%</span></h6>
                                        <div class="progress mb-3" style="height: 7px">
